...
public class ProcessoController {
	...
	@GetMapping(headers = "api-version=v1", value = "/v1"
			+ "/listar/processos/paginados/cursor", produces = APPLICATION_JSON_VALUE)
	@ResponseBody
	...
	@GetMapping(headers = "api-version=v1", value = "/v1"
			+ "/listar/processos/paginados/page", produces = APPLICATION_JSON_VALUE)
	@ResponseBody
	public List<ProcessoDTO> listarProcessosPaginadosPorPagePageSize(@RequestParam Integer page,
			@RequestParam Integer pageSize) {
		return service.listarProcessosPaginadosPorPagePageSize(page, pageSize);
	}

	@GetMapping(headers = "api-version=v1", value = "/v1"
			+ "/listar/processos/paginados/offsetlimit", produces = APPLICATION_JSON_VALUE)
	@ResponseBody
	public List<ProcessoDTO> listarProcessosPaginadosPorOffsetLimit(@RequestParam Integer offset,
			@RequestParam Integer limit) {
		return service.listarProcessosPaginadosPorOffsetLimit(offset, limit);
	}

	@GetMapping(headers = "api-version=v1", value = "/v1" + "/listar/processos/deletados", produces = APPLICATION_JSON_VALUE)
	@ResponseBody
	public List<ProcessoDTO> listarProcessosDeletados(){
		return service.listarProcessosDeletados();
	}
